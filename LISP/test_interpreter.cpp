...
//---STUDENT TESTS---
TEST_CASE("Test parser with multiple atoms in the stream", "[interpreter]")
{
  std::string program = "atom1 atom2";
  std::istringstream iss(program);
...
TEST_CASE("Test parser with single valid atom in the stream", "[intepreter]")
{
  std::string program = "atom1";
  std::istringstream iss(program);
...
TEST_CASE("Test parser with single invalid atom in the stream", "[intepreter]")
{
  std::string program = "1atom";
  std::istringstream iss(program);
...
TEST_CASE("Test parser with extra starting parenthesis", "[intepreter]")
{
  std::string program = "((begin (define r 10) (* pi (* r r))) )";
  std::istringstream iss(program);
...
TEST_CASE("Test result with invalid define", "[intepreter]")
{
...
TEST_CASE("Test result with invalid if", "[intepreter]")
{
